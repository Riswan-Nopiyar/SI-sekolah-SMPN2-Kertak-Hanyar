...
class Guru extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('backend/wali/guru', $data);
    ...
    public function delete()
    {
        ...
        redirect(base_url('wali/guru'), 'refresh');
    }
    ...
    public function update()
    {
        ...
        move_uploaded_file($_FILES['userfile']['tmp_name'], 'assets/images/wali/' . $this->uri->segment(4) . '.jpg');
    ...
    public function save()
    {
        ...
        move_uploaded_file($_FILES['userfile']['tmp_name'], 'assets/images/wali/' . $teacher_id . '.jpg');
