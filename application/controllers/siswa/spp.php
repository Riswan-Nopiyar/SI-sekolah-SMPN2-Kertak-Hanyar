...
class Spp extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['invoices']       = $this->db->get_where('spp', array('student_id' => $this->session->userdata('student_id')))->result_array();

        $this->load->view('backend/temp/header', $data);
        $this->load->view('backend/siswa/sidebar', $data);
        $this->load->view('backend/siswa/spp', $data);
    ...
    public function buat_tagihan()
    {
        ...
        redirect(base_url('siswa/spp'), 'refresh');
    }
