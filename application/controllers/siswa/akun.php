...
class Akun extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('backend/siswa/akun', $data);
    ...
    public function save($param = '')
    {
        ...
        move_uploaded_file($_FILES['userfile']['tmp_name'], 'assets/images/siswa/' . $param . '.jpg');
        $this->session->set_flashdata('flash_message', 'data berhasil diupdate');
        redirect(base_url('siswa/akun'), 'refresh');
    }
    ...
    public function ubah_password($param = '')
    {
        ...
        $current_password = $this->db->get_where('siswa', array(
            'student_id' => $param
        ))->row()->password;
