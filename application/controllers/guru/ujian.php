...
class Ujian extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('backend/guru/ujian', $data);
    ...
    public function nilai($kategori = '', $kelas = '', $pelajaran = '')
    {
        ...
        if ($this->input->post('jenis') == 'tampilkan') {
            ...
            if ($data_nilai['exam_id'] > 0 && $data_nilai['class_id'] > 0 && $data_nilai['subject_id'] > 0) {
                ...
                /* redirect(base_url('guru/ujian/nilai/' . $data['exam_id'] . '/' . $data['class_id'] . '/' . $data['subject_id']), 'refresh'); */
            }
        }

        $this->load->view('backend/temp/header', $data);
        $this->load->view('backend/guru/sidebar', $data);
        $this->load->view('backend/guru/ujian_nilai', $data);
        $this->load->view('backend/temp/footer', $data);
    }
    ...
    public function kategori()
    {
        ...
        $this->load->view('backend/temp/header', $data);
        $this->load->view('backend/guru/sidebar', $data);
        $this->load->view('backend/guru/kategori_nilai', $data);
        $this->load->view('backend/temp/footer', $data);
    }
    ...
    public function delete($param1 = '', $param2 = '')
    {
        if ($param1 == 'ujian') {
            ...
            redirect(base_url('guru/ujian'), 'refresh');
            ...
            $this->session->set_flashdata('flash_message', 'data berhasil dihapus');
            redirect(base_url('guru/ujian/kategori'), 'refresh');
        }
    }
