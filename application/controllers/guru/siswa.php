...
class Siswa extends CI_Controller
{
    ...
    public function informasi($param = '')
    {
        ...
        $this->load->view('backend/guru/siswa_informasi', $data);
    ...
    public function nilai($param = '')
    {
        ...
        $this->load->view('backend/temp/header', $data);
        $this->load->view('backend/guru/sidebar', $data);
        $this->load->view('backend/guru/siswa_rapor', $data);
        $this->load->view('backend/temp/footer', $data);
    }
    ...
    public function tambah()
    {
        ...
        $this->load->view('backend/temp/header', $data);
        $this->load->view('backend/guru/sidebar', $data);
        $this->load->view('backend/guru/siswa_tambah', $data);
        $this->load->view('backend/temp/footer', $data);
    }
    ...
    public function delete()
    {
        ...
        redirect(base_url('guru/siswa/informasi/' . $this->uri->segment(4)), 'refresh');
    }
    ...
    public function save()
    {
        ...
        move_uploaded_file($_FILES['userfile']['tmp_name'], 'assets/images/siswa/' . $student_id . '.jpg');
        $this->session->set_flashdata('flash_message', 'data berhasil disimpan');
        /* $this->email_model->account_opening_email('student', $data['email']); */ //SEND EMAIL ACCOUNT OPENING EMAIL
        if ($this->uri->segment(3) == 'tambah') {
            redirect(base_url('guru/siswa/tambah'), 'refresh');
        } else {
            redirect(base_url('guru/siswa/informasi/' . $this->uri->segment(4)), 'refresh');
        }
    }
