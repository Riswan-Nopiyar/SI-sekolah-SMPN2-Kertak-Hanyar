<?php
$child_of_parent = $this->db->get_where('siswa', array(
    'student_id' => $this->db->get_where('siswa', array('parent_id' => $this->session->userdata('parent_id')))->row()->student_id
))->result_array();
            ...
            <div class="tabs-vertical-env">
                ...
                <div class="tab-content">
                    ...
                    foreach ($exams as $exam) :
                        ...
                        $marks = $this->db->get('nilai_ujian')->result_array();
                    ?>
                            ...
                            <table class="table table-bordered table-hover table-striped responsive">
                                ...
                                <tbody>
                                    <?php foreach ($marks as $mark) : ?>
                                        <tr>
                                            <td>
                                                <?php echo $this->db->get_where('kelas', array(
                                                    'class_id' => $mark['class_id']
                                                ))->row()->name; ?>
                                            </td>
                                            <td>
                                                <?php echo $this->db->get_where('pelajaran', array(
