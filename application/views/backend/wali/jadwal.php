...
<div class="label label-primary pull-right" style="font-size: 14px;">
    ...
    <?= $this->db->get_where('siswa', array('parent_id' => $this->session->userdata('parent_id')))->row()->name; ?>
</div>
<br>
<br>
...
<div class="row">
    <div class="col-md-12">
        <div class="panel-group joined" id="accordion-test-2">
            <?php
            $toggle = true;
            $classes = $this->db->query("select kelas.* from kelas, siswa where kelas.class_id=siswa.class_id and siswa.parent_id='" . $this->session->userdata('parent_id') . "'")->result_array();
