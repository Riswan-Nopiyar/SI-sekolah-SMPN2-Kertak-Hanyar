        ...
        <ul>
            <li>
                <a href="<?= base_url($this->session->userdata('login_type') . '/jadwal'); ?>">
                    <i class="entypo-calendar"></i>
                    <span><?= $this->db->get_where('siswa', array('parent_id' => $this->session->userdata('parent_id')))->row()->name; ?></span>
                </a>
            </li>
        </ul>
    </li>
        ...
        <ul>
            <li class="<?php if ($page_name == 'nilai_ujian') echo 'active'; ?> ">
                <a href="<?= base_url($this->session->userdata('login_type') . '/ujian/nilai'); ?>">
                    <span><i class="entypo-dot"></i> <?= $this->db->get_where('siswa', array('parent_id' => $this->session->userdata('parent_id')))->row()->name; ?></span>
                </a>
            </li>
        </ul>
    </li>
