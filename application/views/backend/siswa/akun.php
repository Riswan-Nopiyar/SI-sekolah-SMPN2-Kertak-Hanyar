        ...
        <div class="tab-content">
            ...
            <div class="tab-pane box active" id="list" style="padding: 5px">
                <div class="box-content">
                    <?php
                    $wali    =    $this->db->get_where('siswa', array('student_id' => $this->session->userdata('student_id')))->result_array();
                    foreach ($wali as $row) : ?>
                        <?php echo form_open(base_url('siswa/akun/save/' . $this->session->userdata('parent_id')), array('class' => 'form-horizontal form-groups-bordered validate', 'target' => '_top', 'enctype' => 'multipart/form-data')); ?>
                            ...
                            <div class="col-sm-5">
                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                    <div class="fileinput-new thumbnail" style="width: 100px; height: 100px;" data-trigger="fileinput">
                                        <img src="<?php echo $this->myModel->get_image_url('siswa', $row['student_id']); ?>" alt="...">
                                    </div>
            ...
            <div class="tab-pane box" id="password" style="padding: 5px">
                <div class="box-content padded">
                    ...
                    $wali    =    $this->db->get_where('siswa', array('student_id' => $this->session->userdata('student_id')))->result_array();
                    foreach ($wali as $row) : ?>
                        <?php echo form_open(base_url('siswa/akun/ubah_password/' . $this->session->userdata('student_id')), array('class' => 'form-horizontal form-groups-bordered validate', 'target' => '_top')); ?>
                        <div class="form-group">
