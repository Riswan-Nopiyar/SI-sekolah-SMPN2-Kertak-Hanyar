...
<hr />
<a href="javascript:;" onclick="showAjaxModal('<?= base_url('modal/popup/spp_tagihan'); ?>');" class="btn btn-primary pull-right">
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                                            ...
                                            <?php if ($row['due'] != 0) : ?>
                                                <li>
                                                    <a href="#" onclick="showAjaxModal('<?= base_url('modal/popup/spp_bayar/' . $row['invoice_id']); ?>');">
                                                        <i class="entypo-right-circled"></i>
                                                        Pembayaran
                                                    </a>
                                                </li>
                                            ...
                                            <!-- EDITING LINK -->
                                            <li>
                                                <a href="#" onclick="showAjaxModal('<?= base_url('modal/popup/spp_edit/' . $row['invoice_id']); ?>');">
                                            ...
                                            <!-- DELETION LINK -->
                                            <li>
                                                <a href="#" onclick="confirm_modal('<?= base_url('admin/spp/delete/' . $row['invoice_id']); ?>');">
