...
<table cellpadding="0" cellspacing="0" border="0" class="table table-bordered table-hover table-striped">
    ...
    <tbody>
        <form method="post" action="<?= base_url('admin/siswa/absen/kelola'); ?>" class="form">
            <tr class="gradeA">
                <td>
                    <input type="text" name="date" class="form-control datepicker" value="<?= $hari ?>">
                </td>
                <td>
...
<?php if ($hari != '') : ?>
    ...
    <div class="row" id="update_attendance">
        ...
        <form method="post" action="<?= base_url('admin/siswa/absen/update'); ?>">
            <div class="col-sm-offset-3 col-md-6">
