        ...
        <div class="tab-content">
            ...
            <div class="tab-pane box active" id="list" style="padding: 5px">
                <div class="box-content">
                    <?php
                    $teachers    =    $this->db->get_where('admin', array('admin_id' => 1))->result_array();
                    foreach ($teachers as $row) : ?>
                        <?php echo form_open(base_url('admin/akun/save/1'), array('class' => 'form-horizontal form-groups-bordered validate', 'target' => '_top', 'enctype' => 'multipart/form-data')); ?>
                            ...
                            <div class="col-sm-5">
                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                    <div class="fileinput-new thumbnail" style="width: 100px; height: 100px;" data-trigger="fileinput">
                                        <img src="<?php echo $this->myModel->get_image_url('admin', $row['admin_id']); ?>" alt="...">
                                    </div>
            ...
            <div class="tab-pane box" id="password" style="padding: 5px">
                <div class="box-content padded">
                    ...
                    $teachers    =    $this->db->get_where('admin', array('admin_id' => 1))->result_array();
                    foreach ($teachers as $row) : ?>
                        <?php echo form_open(base_url('admin/akun/ubah_password'), array('class' => 'form-horizontal form-groups-bordered validate', 'target' => '_top')); ?>
                        <div class="form-group">
